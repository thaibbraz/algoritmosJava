...
import pt.ipleiria.estg.dei.aed.colecoes.iteraveis.associativas.estruturas.TabelaHashPorSondagemComIncrementoLinear;
 ...
 */
public class MainTeoricaTabelaHashPorSondagemComIncrementoLinear {

    public MainTeoricaTabelaHashPorSondagemComIncrementoLinear() {
        TabelaHashPorSondagemComIncrementoLinear<Long, Pessoa> tabelaHashPessoasBI =
                new TabelaHashPorSondagemComIncrementoLinear<>(5);
    ...
    public static void main(String[] args) {
        new MainTeoricaTabelaHashPorSondagemComIncrementoLinear();
    }
}

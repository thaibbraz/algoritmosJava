 ...
 */
public class MainTeoricaTabelaHashPorSondagemComIncrementoQuadratico {

    public MainTeoricaTabelaHashPorSondagemComIncrementoQuadratico() {
        TabelaHashPorSondagemComIncrementoQuadratico<Long, Pessoa> tabelaHashPessoasBI =
                new TabelaHashPorSondagemComIncrementoQuadratico<>(5);
    ...
    public static void main(String[] args) {
        new MainTeoricaTabelaHashPorSondagemComIncrementoQuadratico();
    }
}

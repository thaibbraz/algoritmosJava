 ...
 */
public class TabelaHashPorSondagemComIncrementoLinear<C, V> extends TabelaHashPorSondagem<C, V> {

    private static final long serialVersionUID = 1L;

    public TabelaHashPorSondagemComIncrementoLinear(int tamanho) {
        super(tamanho);
    }
